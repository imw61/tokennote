...
<p align="center">
  <img src="src-tauri/icons/128x128.png" alt="TokenNote Logo" width="128">
</p>
...
**Q：我想在手机上上使用？**
A：在下载中心下载安卓版本（暂不支持ios）。

[https://update.tokennote.dev/releases](https://update.tokennote.dev/releases)。
---
